...
MissionCondition1 = [ "WIN1",{ 
        [ ZONE, "east", "", "< 3"] call dzn_fnc_ccUnits
		&& MTVRAMMO inArea baseTrg
		&& MTVRREP inArea baseTrg
		&& {call fnc_CheckPlayersReturned}
},"All objectives done" ];
MissionCondition2 = [ "WIN2",{ 
		...
		&& !alive MTVRREP
		&& {call fnc_CheckPlayersReturned}
},"Zone clear, Repair MTVR destroed" ];
MissionCondition3 = [ "WIN3",{ 
        [ ZONE, "east", "", "< 3"] call dzn_fnc_ccUnits
		&& !alive MTVRAMMO
		&& MTVRREP inArea baseTrg
		&& {call fnc_CheckPlayersReturned}
},"Zone clear, Ammo MTVR destroed" ];
MissionCondition4 = [ "WIN4",{ 
        [ ZONE, "east", "", "< 3"] call dzn_fnc_ccUnits
		&& !alive MTVRAMMO
		&& !alive MTVRREP
		&& {call fnc_CheckPlayersReturned}
},"Zone clear, 2 MTVR destoed" ];
MissionCondition5 = [ "WIPED", { call fnc_isAllDead }, "All dead", 30 ];
